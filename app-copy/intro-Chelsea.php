    ...
    <div class="content">
        ...
        <div class="teacher_info">
            ...
            <section class="info info_1">
                <img src="./images/teacher/P/Chelsea.jpg" alt="" />
                <h3>基本资料</h3><span>Basic information</span>
                <article>
                    <p>昵称：Chelsea</p>
                    <p>国籍：菲律宾</p>
                    <p>教师证书：TESL</p>
                    <p>兴趣爱好：唱歌、跳舞，看浪漫和有趣的电影</p>
            ...
            <section class="info info_2">
                ...
                <div id="video">
                    <video class="video-js vjs-default-skin" controls preload="none" poster="images/video.jpg" data-setup="{}">
                        <source src="http://7sbxpa.com1.z0.glb.clouddn.com/Chelsea.mp4" type='video/mp4' />
                        <source src="http://7sbxpa.com1.z0.glb.clouddn.com/Chelsea.mp4" type='video/webm' />
                        您的浏览器不支持该视频，请更换浏览器后重试。
                    </video>
                </div>
                
                <article>
                    <p>Hi! I’m teacher Chelsea. I’m friendly and very jolly. I like singing and dancing. I love watching romantic and funny movies. I’m interested in meeting and teaching new people. I will make sure that you not only learn but also have fun in class with me.</p>
                    <p>嗨！我是Chelsea，我很活泼友善哦。我喜欢唱歌和跳舞，喜欢看浪漫和有趣的电影。我喜欢会议以及教授新的学员。我确信在我的课堂上，你会学得开心，玩得开心哟！</p>
                </article>
            </section>
        </div>
	</div><!-- end content -->    
