    ...
    <div class="content">
        ...
        <div class="teacher_info">
            ...
            <section class="info info_1">
                <img src="./images/teacher/P/Nica.jpg" alt="" />
                <h3>基本资料</h3><span>Basic information</span>
                <article>
                    <p>昵称：Nica</p>
                    <p>国籍：菲律宾</p>
                    <p>教师证书：TEFL、TESOL、TESL</p>
                    <p>兴趣爱好：看电视、上网、听歌、读书等</p>
            ...
            <section class="info info_2">
                ...
                <div id="video">
                    <video class="video-js vjs-default-skin" controls preload="none" poster="images/video.jpg" data-setup="{}">
                        <source src="http://7sbxpa.com1.z0.glb.clouddn.com/Nica.mp4" type='video/mp4' />
                        <source src="http://7sbxpa.com1.z0.glb.clouddn.com/Nica.mp4" type='video/webm' />
                        您的浏览器不支持该视频，请更换浏览器后重试。
                    </video>
                </div>
                
                <article>
                    <p>Hi! I am Teacher Nica. I've been teaching english for 2 years. I really love to teach my students because I want to share to them my knowledge and experiences. Also, I want them to experience that it is fun to learn.</p>
                    <p>大家好，我是Nica老师，已从事英语教学2年。喜欢教学，因为可以和学生分享我的知识和经验，同时，让学生快乐的学习。</p>
                </article>
            </section>
        </div>
	</div><!-- end content -->    
