...
function width_medium(){
	...
	if($('.nav li').hasClass('t_li') == false){
		$('.nav ul:last-child').append('<li class="t_li"><a href="apply.html" target="_self">申请试听</a></li>');
	}
}
...
function width_min(){
	...
	if($('.nav li').hasClass('m_li') == false){
		$('.nav ul:last-child').append('<li class="m_li"><a href="apply.html" target="_self">申请免费试听</a></li><li class="m_li"><aside class="aside_hide"><div><img src="./images/aside_hide.png" alt="" /></div></aside></li>');
	}
